#!/usr/bin/env python3
"""
build_indexes.py (render_index.py)
  ...
  <style>
    ...
    * {{
    ...
    body {{
      ...
      margin: 0;
      padding: 32px 0 48px; /* layout container handles horizontal padding */
      color: var(--white);
      background:
    ...
    /* hero uses same 2-col geometry as episode grid */
    .hero-split {{
      display: grid;
    ...
    /* centered over the right column (column 2) */
    .listen-center {{
      justify-self: center;
      text-align: center;
    }}
